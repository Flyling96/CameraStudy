...
namespace Cinemachine
{
    ...
    public class CinemachineVirtualCamera : CinemachineVirtualCameraBase
    {
        ...
        override public void InternalUpdateCameraState(Vector3 worldUp, float deltaTime)
        {
            ...
            m_State = CalculateNewState(worldUp, deltaTime,m_State);
        ...
        private CameraState CalculateNewState(Vector3 worldUp, float deltaTime, CameraState PreviousState)
        {
            // Initialize the camera state, in case the game object got moved in the editor
            CameraState state = PullStateFromVirtualCamera(worldUp, ref m_Lens);
            state.PreviousPosition = PreviousState.FinalPosition;
            state.PreviousOrientation = PreviousState.FinalOrientation;
